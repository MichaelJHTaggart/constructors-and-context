...
/*
 Below we have the constructor Animal.  The eat method is using the "this" keyword.  Use the "new" keyword to assign context to "this", and save the 
...
const animal1 = new Animal('Monkey','Monkey things', 'bananas')
...
const whoSaysHi = sayHi.bind(name)
